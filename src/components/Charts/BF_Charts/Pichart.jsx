...
const Pichart = ({topText,topTextvalue,option,series,bottomText,bottomTextvalue,wid}) => {
  ...
  return (
    <div className={` flex flex-col items-center  w-[18vw]   h-auto  gap-[28px] flex-shrink-0 rounded-[12px] `}>
    {/* top text */}
    ...
    {/* pi chart */}
      ...
      <div id="chart" className=" w-[full] flex flex-col">
        <ReactApexChart
          options={option}
          series={series}
          type="pie"
