...
const BF_Dashboard = () => {
  ...
  return (
    <div className="w-full gap-5 h-screen">
      <h1 className="text-3xl sm:text-4xl font-semibold text-[#024D87]">
        BLAST FURNACE
      </h1>

      <div className="bg-[#F6F7FA] mt-[20px] pl-3 pr-3 sm:pl-5 sm:pr-5 font-poppins flex flex-col rounded-lg">
        <Tabs>
          ...
          <TabPanels className="h-[80vh] overflow-y-auto">
