  ...
  return (
    <div class="bg-[#F1F7FF] flex text-center w-[100%] p-3 h-[80px] rounded-xl">
      <div class="w-[15%]  flex h-full items-center justify-center ">
        <p class="text-[14px] font-semibold text-left  items-center justify-center">Current Ore-Coke ratio</p>
      </div>
      <div class="w-[28%] p-3 flex justify-center  h-full gap-1 ">
        <div class="w-[75%] flex gap-2  justify-center items-center"> 
        ...
        <div class="w-[25%] flex items-center justify-center">
            {
                blockC>5? <img src="/increasered.svg" alt="" />: <img src="/normalindicator.svg" alt=""  />
            }
        </div>
      </div>
      <div class="w-[28%] flex justify-center  h-full gap-4">
        <div class="w-[75%] flex gap-2  justify-center items-center"> 
        ...
        <div class="w-[25%] flex items-center justify-center">
            {
                blockD>5? <img src="/increasered.svg" alt="" />: <img src="/normalindicator.svg" alt=""  />
            }
        </div>
      </div>
      <div class="w-[28%] flex justify-center   h-full gap-4">
        ...
        <div class="w-[25%] flex items-center justify-center">
            {
                blockE>5? <img src="/increasered.svg" alt="" />: <img src="/normalindicator.svg" alt=""  />
            }
        </div>
      </div>
    </div>
