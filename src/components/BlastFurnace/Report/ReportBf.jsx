...
const ReportBf = () => {
  ...
  return (
    <div className="w-full bg-white h-full rounded-sm p-2 flex flex-col gap-4">
      ...
      <div className="w-[300px] gap-4 flex justify-end">
      {selectedRange == 1 && (
            <div className="min-w-[110px]">
              <FloatingInput
                text="From"
      ...
      {dummyData && !serverdown && (
        <div className="w-full h-full ">
          ...
          <div className={`grid ${size.width<1024?"grid-cols-2":"grid-cols-4"}  gap-6 text-[#49454F] text-xs lg:text-base w-full p-2 border-2 rounded-[10px]`}>
            <div
          ...
          <div className={`flex ${size.width<1024?"flex-col h-full":"h-full  overflow-x-auto"}  w-full p-2  gap-2  mb-[10px] `}>
