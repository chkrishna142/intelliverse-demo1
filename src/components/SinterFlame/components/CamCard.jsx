  ...
  return (
    <div className="relative flex flex-col gap-4 pt-1 pb-4 p-6">
      ...
      <div className="flex flex-col sm:flex-row gap-6 items-center">
        ...
        {!data.lidDown ? (
          <div className="flex flex-col h-full items-center gap-4 w-full sm:min-w-[35vw] xl:min-w-[15vw]">
            <p className="text-xs sm:text-base text-black self-start">
              Health Index
            </p>
            <IndexChart type={"Flame"} value={data.index} />
          </div>
        ) : (
          <div className="h-full flex flex-col gap-8 items-center justify-center text-black font-bold text-center text-2xl w-full sm:min-w-[35vw] xl:min-w-[15vw]">
            <img src="/SinterflameIcons/viewObstruct.svg" className="h-[10vh]" />
            <p>View Obstructed</p>
          </div>
        )}
      </div>
