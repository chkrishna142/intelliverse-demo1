                        ...
                        <div className='mt-8 flex flex-wrap gap-8 text-sm items-center'>
                            ...
                            <div>
                                <div className='w-28 h-32 rounded-xl shadow-md border border-gray-200 hover:bg-blue-100 hover:transition duration-200 cursor-pointer '>
                                    ...
                                    <div className='w-full flex justify-center text-[#024D87]  text-xs'><div className='bg-[#CCEAFF] px-2 py-1 w-full font-bold text-xs'>3 Deployments</div></div>
                                </div>
                                <div className='mt-4 flex justify-center h-10 w-28'><p className='font-bold text-[#024D87]'>Tracking Tool</p></div>
                            </div>
                            <div>
                                <div className='w-28 h-32 rounded-xl shadow-md border border-gray-200 hover:bg-blue-100 hover:transition duration-200 cursor-pointer '>
                            ...
                            <div>
                                ...
                                <div className='mt-4 flex justify-center h-10 w-28'><p className='font-bold text-[#024D87] text-center'>Quality Inspection</p></div>
                            </div>
                            <div>
                                <div className='w-28 h-32 rounded-xl shadow-md border border-gray-200 hover:bg-blue-100 bg-gray-200 hover:transition duration-200 cursor-pointer '>
